...
const HomeSecondSingleService = ({title, text, iconText, image}) => {
   return (
      <>
         <div className="services__nav-content pt-50 pb-50">
            <div className="row">
               <div className="col-xl-4 col-lg-6">
                  <div className="services__thumb text-lg-right m-img">
                     <img src={`assets/img/services/services-${image}.png`} alt="" />
                  </div>
               </div>
